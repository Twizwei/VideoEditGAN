...
stylegan2_ada_car = './pretrained_models/stylegan2-car-config-f.pt'
style_clip_pretrained_mappers = './pretrained_models'
ir_se50 = './pretrained_models/model_ir_se50.pth'
dlib = './pretrained_models/align.dat'

## Dirs for output files
checkpoints_dir = './PTI_checkpoints'
embedding_base_dir = './PTI_embeddings'
styleclip_output_dir = './StyleCLIP_results'
experiments_output_dir = './output'
visualization_dir = './PTI_visuals/'

## Input info
### Input dir, where the images reside
input_data_path = './clip_test'

### Inversion identifier, used to keeping track of the inversion results. Both the latent code and the generator
input_data_id = 'ffhq-cliptest'
